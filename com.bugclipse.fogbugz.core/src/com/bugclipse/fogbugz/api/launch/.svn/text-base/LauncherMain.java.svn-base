...
//		XMLInstance2Schema.main(new String[]{"data/payload2.xml"});
		SourceGeneratorMain.main(new String[] { "-i", "data/fogbugz-api2.xsd",
				"-package", "com.bugclipse.fogbugz.api", "-dest", "src/",
				"-binding-file", "data/srcgen-binding.xml" });
		// Unmarshaller un = new Unmarshaller(Response.class);
		// Object o = un.unmarshal(new FileReader("data/payload2.xml"));
		// if (o instanceof Response) {
		// Response r = (Response) o;
		// System.out.println("email -
		// "+r.getCases().getCase().getSCustomerEmail());
		// System.out.println("event desc -
		// "+r.getEvents().getEvent().getEvtDescription());
