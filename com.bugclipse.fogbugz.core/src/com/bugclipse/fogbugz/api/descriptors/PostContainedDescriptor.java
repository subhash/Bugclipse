...
import com.bugclipse.fogbugz.api.PostContained;

/**
 * Class PostContainedDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class PostContainedDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public PostContainedDescriptor() {
        super();
        _xmlName = "post";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                PostContained target = (PostContained) object;
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    // if null, use delete method for optional primitives 
                    if (value == null) {
                        target.deleteIxDiscussTopicParent();
                        return;
                    }
    ...
    public java.lang.Class getJavaClass(
        ...
        return com.bugclipse.fogbugz.api.PostContained.class;
    }
