...
/**
 * Class CaseResponseDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class CaseResponseDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public CaseResponseDescriptor() {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                CaseResponse target = (CaseResponse) object;
    ...
    public java.lang.Class getJavaClass(
        ...
        return com.bugclipse.fogbugz.api.CaseResponse.class;
    }
